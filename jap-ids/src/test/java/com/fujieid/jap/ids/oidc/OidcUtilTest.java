...
public class OidcUtilTest extends BaseIdsTest {
    ...
    public void getOidcDiscoveryInfoNotNull() {
        OidcDiscoveryDto discoveryDto = OidcUtil.getOidcDiscoveryInfo(null, JapIds.getIdsConfig());
    ...
    public void getJwksPublicKey() {
        String jwks = OidcUtil.getJwksPublicKey(null, JapIds.getIdsConfig());
    ...
    public void getJwksPublicKeyNullJwksJson() {
        ...
        Assert.assertThrows(InvalidJwksException.class, () -> OidcUtil.getJwksPublicKey(null, JapIds.getIdsConfig()));
    }
}
